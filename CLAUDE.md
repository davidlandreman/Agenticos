...
- `src/commands/` — Remaining kernel-side GUI apps (`painting`, `tasks`, `explorer`) + `guishell`. Calc and Notepad are ring-3 ELFs under `userland/apps/`. See [`src/commands/CLAUDE.md`](src/commands/CLAUDE.md).
