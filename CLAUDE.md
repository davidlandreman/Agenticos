...
- `src/commands/` — Remaining kernel-side GUI apps (`painting`, `calc`, `explorer`) + `guishell`. Notepad and the Task Manager are ring-3 ELFs under `userland/apps/`. See [`src/commands/CLAUDE.md`](src/commands/CLAUDE.md).
