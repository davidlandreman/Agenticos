...
- `src/commands/` — Remaining kernel-side GUI apps (`tasks`, `explorer`) + `guishell`. Calc, notepad, painting, and GL Arena are ring-3 ELFs under `userland/apps/`. See [`src/commands/CLAUDE.md`](src/commands/CLAUDE.md).
