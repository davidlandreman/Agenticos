...
- `src/commands/` — Remaining kernel-side GUI app (`explorer`) + `guishell`. Calc, notepad, painting, and the Task Manager are ring-3 ELFs under `userland/apps/`. See [`src/commands/CLAUDE.md`](src/commands/CLAUDE.md).
